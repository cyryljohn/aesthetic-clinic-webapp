  ...
  const teamMembers = [
    {
      ...
      className: "absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 rotate-[-15deg] z-10",
    },
    {
      ...
      className: "absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 rotate-[8deg] z-20",
    },
    {
      name: "Jennifer Park",
      ...
      className: "absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 rotate-[-5deg] z-15",
    },
    {
      name: "Maria Silva",
      ...
      className: "absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 rotate-[12deg] z-25",
    },
    {
      name: "Dr. Emily Zhang",
      role: "Cosmetic Surgeon",
      image: "https://images.unsplash.com/photo-1651008376811-b90baee60c1f?q=80&w=2387&auto=format&fit=crop",
      className: "absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 rotate-[-8deg] z-18",
    },
    {
      name: "Sophie Laurent",
      role: "Laser Specialist",
      image: "https://images.unsplash.com/photo-1580281658524-b8e0bbe5751b?q=80&w=2342&auto=format&fit=crop",
      className: "absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 rotate-[6deg] z-22",
    },
    {
      name: "Nina Rodriguez",
      ...
      className: "absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 rotate-[-10deg] z-12",
    },
  ];
