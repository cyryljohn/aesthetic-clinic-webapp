...
const AnimatedHero: React.FC = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-gradient-to-br from-gray-950 via-primary-950/20 to-gray-950">
      {/* Animated Background */}
      <BackgroundBeams />
      ...
      <div className="absolute inset-0">
        ...
        />
        <motion.div
          className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-secondary-500/30 rounded-full filter blur-3xl"
          animate={{
            x: [0, -100, 0],
            y: [0, 100, 0],
          }}
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-display font-bold text-white mb-6">
              ...
              />
              <motion.span
                className="text-transparent bg-clip-text bg-gradient-to-r from-primary-400 to-secondary-400 inline-block"
            ...
            >
              ...
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <button className="px-8 py-4 border-2 border-white/20 text-white font-medium rounded-lg hover:bg-white/10 backdrop-blur-sm transition-all duration-200">
                  View Services
                </button>
              </motion.div>
            </motion.div>
            ...
            >
              {[
                { value: '500+', label: 'Happy Clients', delay: 2.2 },
                { value: '15+', label: 'Expert Specialists', delay: 2.4 },
                { value: '4.9★', label: 'Google Rating', delay: 2.6 },
              ].map((stat) => (
                <motion.div
                  key={stat.label}
                  initial={{ opacity: 0, y: 20 }}
                ...
                >
                  <motion.p
                    className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-primary-400 to-secondary-400"
          ...
          >
            {/* Central Image */}
            <motion.div
              className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-80"
              animate={{
                y: [0, -20, 0],
              }}
              transition={{
            ...
            {floatingImages.map((img, index) => (
              <motion.div
                key={index}
                className="absolute w-32 h-40 rounded-xl overflow-hidden shadow-xl"
                style={{
                  top: '50%',
                  left: '50%',
                  x: img.x,
